    ...
    <div class="container-main">
      ...
      <div class="container-ui">
        ...
        <div class="select-container">
          <img v-on:click="moveTypeSelectorBackwards()" class="arrow button" src="/public/svgs/ArrowLeft.svg" />
          <div class="select texto">{{  types[typeSelector] || "Loading data..." }}</div>
          <img v-on:click="moveTypeSelectorForwards()" class="arrow button" src="/public/svgs/ArrowRight.svg" />
        </div>
