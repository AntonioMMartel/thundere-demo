  ...
  <div v-on:wheel="changePageOnScroll($event)" class="container-main">
    ...
    <div class="container-ui">
      ...
      <div class="country-view">  
        ...
        <img ref="left" v-if="Object.keys(this.data).length > 6" v-on:click="decreasePageCounter()" class="page-arrow left-arrow button" src="/public/svgs/ArrowLeft.svg" />
        ...
        <img ref="right" v-if="Object.keys(this.data).length > 6" v-on:click="increasePageCounter()" class="page-arrow right-arrow button" src="/public/svgs/ArrowRight.svg" />
      </div>
...
export default {
  ...
  computed: {
    shownData() {
      return Object.entries(this.data).slice(this.page * 6, (this.page + 1) * 6)
    }
  }
